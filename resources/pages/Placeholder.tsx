...
const PageNotFound: React.FC = () => {
  ...
  return (
    <MainLayout
      title="Litestar Application - Under Construction"
      ...
      <div className="w-full h-screen flex items-center justify-center px-2 md:px-0">
        <div className="lg:flex lg:items-center lg:space-x-10">
          ...
          />
          <div>
            <p className="mt-6 text-sm font-semibold text-black">Under Construction</p>
            <h1 className="mt-3 text-2xl font-semibold text-gray-800 md:text-3xl">We are working on this page</h1>
